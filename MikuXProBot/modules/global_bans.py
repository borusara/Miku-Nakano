...
def gban(update: Update, context: CallbackContext):
    ...
    message.reply_text("I swear to defeat him/her...")
    ...
    if gban_time > 60:
        ...
        message.reply_text("Done! Mahiru San will keep him/her Away! from your chats.", parse_mode=ParseMode.HTML)
    else:
        message.reply_text("Done! Mahiru San will kick his/her ass wherever i see this user! MUAHAHAHAHA", parse_mode=ParseMode.HTML)
